...
// Register the login service so it can be used in our controller.
builder.Services.AddScoped<ServiceApi.Services.ILoginService, ServiceApi.Services.LoginService>();
